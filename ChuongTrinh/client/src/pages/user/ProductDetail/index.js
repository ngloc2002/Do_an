...
function ProductDetail() {
    ...
    const addToCart = async (idProduct) => {
        ...
        if (qty > product.quantity|| product?.quantity <= 0) {
            (product?.quantity <= 0) ?notify('error', 'Sản phẩm tạm hết hàng !'): notify('warning', `Tối đa ${product.quantity} sản phẩm !`);
            return;
        }
                        ...
                        <div className="row">
                            ...
                            <main className="col-md-6">
                                <article className="product-info-aside">
                                    ...
                                    <dl className="row">
                                        <dt className="col-6 col-sm-4 col-md-6 col-lg-4">Đã bán</dt>
                                        <dd className="col-6 col-sm-8 col-md-6 col-lg-8">
                                            {product && product.buyturn}
                                        </dd>
                                        ...
                                        {product.quantity > 0 ? (
                                            ...
                                            <dd className="col-6 col-sm-8 col-md-6 col-lg-8">
                                                <MDBBadge color='danger'>Hết hàng</MDBBadge>
                                            </dd>
                                        )}
                                    </dl>
