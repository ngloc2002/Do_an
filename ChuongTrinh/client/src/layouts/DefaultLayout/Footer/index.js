                    ...
                    <MDBRow className="mt-3">
                        <MDBCol md="5" lg="5" className="mb-4">
                            <div className="text-uppercase fw-500 mb-4">
                                ...
                                <span className="ms-2">WOW Corporation</span>
                            </div>
                            <p>
                                Mỗi khách hàng là một con người – một cá thể riêng biệt, cần được tôn trọng, quan tâm và
                                lắng nghe, thấu hiểu và phục vụ một cách riêng biệt. WOW sẽ là nơi hiểu được nhu cầu
                        ...
                        <MDBCol md="4" lg="3" className="mx-auto mb-md-0 mb-4">
                            ...
                            <p>
                                ...
                                ngloc2002.dev@gmail.com
                            </p>
                            <p>
                                <MDBIcon icon="phone" className="me-4" />096 123 4567
                            </p>
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>
