...
import { TbReportMoney, TbDiscount2, TbReportMedical } from 'react-icons/tb';
                ...
                <header>
                    <div className={cx('image-text')}>
                        ...
                        <div className={cx('text logo-text')}>
                            <span className={cx('name')}>WOW</span>
                ...
                <div className={cx('menu-bar')}>
                    <div className={cx('menu')}>
                        ...
                        <ul className={cx('menu-links')}>
                            ...
                            <li
                                className={cx('nav-link', {
                                    'd-none': search && !'Feed'.toLowerCase().includes(search.toLowerCase()),
                                })}
                            >
                                <NavLink to="/admin/feed">
                                    <TbReportMedical className={cx('icon')} />
                                    <span className={cx('text nav-text')}>Feed</span>
                                </NavLink>
                            </li>
